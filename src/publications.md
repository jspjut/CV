...
1.  [Joohwan Kim][joohwankim], [Arjun Madhusudan][amadhusudan], [Benjamin Watson][bwatson], [Ben Boudaoud][bboudaoud], [Roland Tarrazo][rtarrazo], **[Josef Spjut][jspjut]**;
**Display Size and Targeting Performance: Small Hurts, Large May Help**, *SIGGRAPH Asia*, November 22, 2022.
[paper](https://dl.acm.org/doi/10.1145/3550469.3555396)
1.  [Ben Boudaoud][bboudaoud], **[Josef Spjut][jspjut]**, [Joohwan Kim][joohwankim], [Arjun Madhusudan][amadhusudan], [Benjamin Watson][bwatson];
**Esports and expertise: what competitive gaming can teach us about mastery**, *ACM Interactions*, November-December, 2022.
[paper](https://dl.acm.org/doi/10.1145/3567954)
1.  [Ben Boudaoud][bboudaoud], **[Josef Spjut][jspjut]**, [Joohwan Kim][joohwankim];
**Mouse Sensitivity in First-person Targeting Tasks**, *IEEE Conference on Games*, August 21, 2022.
[paper](https://ieeexplore.ieee.org/document/9893626)
1.  [Simone Kriglstein][skriglstein], [Anna Lisa Martin-Niedecken][amartin], **[Josef Spjut][jspjut]**, [Nicole B. Damen][ndamen], [Selen Turkay][sturkay], [Anders Drachen][adrachen];
**Esports Meets Human-Computer Interaction**, *ACM Interactions*, May 2, 2022.
...
**Latency of 30 ms Benefits First Person Targeting Tasks More Than Refresh Rate Above 60 Hz**, *SIGGRAPH Asia Technical Briefs*, November 17-20, 2019.
...
**Temporally Dense Ray Tracing**, *High Performance Graphics*, Strasbourg, July 8, 2019.
...
**SIDOD: A Synthetic Image Dataset for 3D Object Pose Recognition with Distractors**, *The IEEE Conference on Computer Vision and Pattern Recognition (CVPR) Workshops*, Long Beach, June 16, 2019.
...
**Fluidic Elastomer Actuators for Haptic Interactions in Virtual Reality**, *IEEE Robotics and Automation Letters (RA-L)*, None, February, 2019.
...
**A Variable Shape and Variable Stiffness Controller for Haptic Virtual Interactions**, *IEEE International Conference on Soft Robotics*, April 24-28, 2018.
...
**Hybrid Modulation for Near Zero Display Latency**, *Society of Information Display*, May 24-27, 2016.
...
**Memory Considerations for Low Energy Ray Tracing**, *Computer Graphics Forum*, August 7, 2014.
...
1.  [Daniel Kopta][dkopta], [Konstantin Shkurko][kshkurko], **[Josef Spjut][jspjut]**, [Erik Brunvand][elb], [Al Davis][ald];
**An Energy and Bandwidth Efficient Ray Tracing Architecture**, *High-Performance Graphics (HPG 2013)*, Anaheim, July 10-21, 2013.
...
**SWEL: Hardware Cache Coherence Protocols to Map Shared Data onto Shared Caches**, *19th International Conference on Parallel Architectures and Compilation Techniques (PACT-19)*, Vienna, September, 2010.
...
**TRaX: A Multicore Architecture for Real-Time Ray Tracing**, *IEEE Transactions on Computer Aided Design of Integrated Circuits and Systems (TCAD)*, December, 2009.
[paper](http://www.cs.utah.edu/~dkopta/papers/hwrt_tcad09.pdf)
1.  **[Josef Spjut][jspjut]**, [Andrew Kensler][aek], [Erik Brunvand][elb];
**Hardware-accelerated gradient noise for graphics**, *Proceedings of the 19th ACM Great Lakes Symposium on VLSI (GLSVLSI'09)*, Boston, May 10-12, 2009.
...
**Optimizing a Multi-Core Processor for Message-Passing Workloads**, *5th Workshop on Unique Chips and Systems (UCAS-5)*, Boston, April, 2009.
...
**TRaX: A Multi-Threaded Architecture for Real-Time Ray Tracing**, *Symposium on Application Specific Processors (SASP)*, Anaheim, June 8-9, 2008. **(Best paper award)**
...
1.  [Adam Marrs][amarrs], **[Josef Spjut][jspjut]**, [Holger Gruen][hgruen], [Rahul Sathe][rsathe], [Morgan McGuire][mmcguire];
**Improving Temporal Antialiasing with Adaptive Ray Tracing**, *Ray Tracing Gems*, March, 2019.
...
**Stretchable Transducers for Kinesthetic Interactions in Virtual Reality**, *SIGGRAPH Emerging Technologies*, Los Angeles, July 30 - August 3, 2017.
...
**Stretchable Transducers for Haptic Interactions in Virtual and Augmented Reality**, *GPU Technology Conference VR Village*, San Jose, May 9 - 11, 2017.
...
[paper](None)
1.  [Benjamin Watson][bwatson], **[Josef Spjut][jspjut]**, [Byungjoo Lee][blee], [Greg Ward][gward];
**FirstPersonScience: An Open Source Tool for Studying FPS Esports Aiming**, *SIGGRAPH Frontiers Workshop*, Vancouver, August 10, 2022.
[paper](https://research.nvidia.com/publication/2022-08_esports-frontier-rendering-interaction-and-display)
1.  [Ben Boudaoud][bboudaoud], **[Josef Spjut][jspjut]**, [Pyarelal Knowles][pknowles], [Arjun Madhusudan][amadhusudan], [Joohwan Kim][joohwankim];
**FirstPersonScience: An Open Source Tool for Studying FPS Esports Aiming**, *SIGGRAPH Talk*, Online, August 8, 2022.
...
**The Augmented Frontier: Challenges for Near Eye Display Computing**, *[AR In Action](http://arinaction.org/)*, Boston, January 16-17, 2018.
...
**Stretchable Transducers for Kinesthetic Interactions in Virtual Reality**, *SIGGRAPH Experience Presentations*, Los Angeles, August 3, 2017.
[paper](http://research.nvidia.com/sites/default/files/publications/peele_siggraph_etech17.pdf)
1.  **[Josef Spjut][jspjut]**, [Richard Piersall][rpiersall], [Kirklann Lau][klau];
**Build your own game controller**, *SIGGRAPH Studio*, Los Angeles, August 10, 2015. **(Studio Course)**
...
## Dissertation
1.  **[Josef Spjut][jspjut]**;
**Efficient Ray Tracing Architectures**, *University of Utah Dissertation*, May, 2015.
...
**Modular prescription augmented reality display**, 2023. **Pending**
[paper](https://patents.google.com/patent/US20230251508A1/en)
1.  [Joohwan Kim][joohwankim], **[Josef Spjut][jspjut]**;
**Cheat detection by comparing mouse input and frame buffer**, 2023. **Pending**
...
**Adding greater realism to a computer-generated image by smoothing jagged edges within the image in an efficient manner**, 2022. **Pending**
...
1.  [Chris Larson][clarson], **[Josef Spjut][jspjut]**, [Ross Knepper][rknepper], [Robert Shepherd][rshepherd];
**OrbTouch: Recognizing Human Touch in Deformable Interfaces with Deep Neural Networks**, *Tech Report, arXiv:1706.02542*, June, 2017.
...
**An Approach to Data Prefetching Using 2-Dimensional Selection Criteria**, *Tech Report, arXiv:1505.03899*, May, 2015.
...
**Sphynx: A Shared Instruction Cache Exporatory Study**, *Tech Report, arXiv:1412.1140*, December 3, 2014.
[paper](http://arxiv.org/abs/1412.1140)
1.  [Eric Storm][estorm], **[Josef Spjut][jspjut]**;
**A Time-to-Recache Case Study**, *Tech Report*, March, 2014.
...
**Qualitative Cache Performance Analysis**, *Tech Report*, September, 2013.
[paper](http://josef.spjut.me/pubs/carterttr13.pdf)
1.  **[Josef Spjut][jspjut]**, [Seth Pugsley][spugsley];
**Time to Recache: Measuring Memory Miss Behavior**, *Tech Report*, September, 2011.
...
**Fast, Effective BVH Updates for Dynamic Ray-Traced Scenes Using Tree Rotations**, *Tech Report, UUCS 11-002, University of Utah*, July, 2011.
...
1.  [Joohwan Kim][joohwankim], **[Josef Spjut][jspjut]**, [Morgan McGuire][mmcguire], [Alexander Majercik][zmajercik], [Ben Boudaoud][bboudaoud], [Rachel Brown (Albert)][ralbert], [David Luebke][dluebke];
**Esports Arms Race: Latency and Refresh Rate for Competitive Gaming Tasks**, *Vision Science Society*, St. Pete Beach, May 17-22, 2019.
[paper](https://www.visionsciences.org/programs/VSS_2019_Abstracts.pdf)
1.  [Mona Jalal][mjalal], **[Josef Spjut][jspjut]**, [Ben Boudaoud][bboudaoud], [Margrit Betke][mbetke];
**Large-scale Synthetic Domain Randomized 6DoF Object Pose Estimation Dataset**, *New England Computer Vision Workshop*, Boston, November 26, 2018.
[paper](http://josef.spjut.me/pubs/jalal18_poster.pdf)
1.  [Daniel Kopta][dkopta], **[Josef Spjut][jspjut]**, [Erik Brunvand][elb];
**Grid-Based Ray Tracing for a Parallel Computing Architecture**, *High Performance Graphics (HPG'09)*, New Orleans, August 1-3, 2009.
...
**Comparing Incoherent Ray Performance of TRaX vs. Manta**, *IEEE Symposium on Interactive Ray Tracing (RT08)*, August 9-10, 2008.
[paper](http://josef.spjut.me/pubs/kopta_rt08.pdf)
   ...
   [joohwankim]: https://research.nvidia.com/person/joohwan-kim
   [youngmojeong]: http://www.youngmoj.com/
   [mstengel]: https://scholar.google.com/citations?user=9_GCtwUAAAAJ
   [ralbert]: http://www.rachelabrown.com/
   [rbrown]: http://www.rachelabrown.com/
   ...
   [skriglstein]: https://www.fi.muni.cz/~kriglstein/
   [amartin]: https://gamedesign.zhdk.ch/en/people/team/anna-lisa-martin-niedecken/
   [ndamen]: https://www.linkedin.com/in/thenicoledamen/
   [sturkay]: https://www.qut.edu.au/about/our-people/academic-profiles/selen.turkay
   [adrachen]: https://arc.york.ac.uk/index.php/anders-drachen/
   [blee]: https://scholar.google.com/citations?user=n1fr4iIAAAAJ
